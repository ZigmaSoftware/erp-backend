...
class CustomerApprovalService:
    ...
    1. Site/Entry Level - approve_status
    ...
    def reject_site(self, entity_unique_id, approver_id, approver_name="", remarks="", site_id=None):
        if not remarks:
