...
class CustomerCreationMaster(BaseMaster):
    ...
    # Sales Service owns no local copy of Master Service's geography masters.
    # These store the Country/State/District/City `unique_id` from Master
    # Service as a plain value (no DB-level FK) - see SALES_SERVICE_README.md.
